# @minecraft-types/jdk.naming.rmi

TypeScript type definitions for the JVM `jdk.naming.rmi` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.naming.rmi
# or
pnpm add @minecraft-types/jdk.naming.rmi
```
