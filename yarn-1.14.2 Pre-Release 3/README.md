# @minecraft-types/yarn-1.14.2 Pre-Release 3

Typescript definitions for Minecraft 1.14.2 Pre-Release 3 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.14.2 Pre-Release 3
# or
pnpm add @minecraft-types/yarn-1.14.2 Pre-Release 3
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.14.2 Pre-Release 3/build.<BUILD_NUMBER>"
    ]
  }
}
```
