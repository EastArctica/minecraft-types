...
TypeScript type definitions for the JVM `jdk.management.jfr` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.management.jfr
# or
pnpm add @minecraft-types/jdk.management.jfr
```
