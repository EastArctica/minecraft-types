...
TypeScript type definitions for the JVM `jdk.management` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.management
# or
pnpm add @minecraft-types/jdk.management
```
