...
TypeScript type definitions for the JVM `jdk.incubator.vector` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.incubator.vector
# or
pnpm add @minecraft-types/jdk.incubator.vector
```
