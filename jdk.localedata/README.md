...
TypeScript type definitions for the JVM `jdk.localedata` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.localedata
# or
pnpm add @minecraft-types/jdk.localedata
```
