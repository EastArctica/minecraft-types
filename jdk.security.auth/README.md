...
TypeScript type definitions for the JVM `jdk.security.auth` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.security.auth
# or
pnpm add @minecraft-types/jdk.security.auth
```
