...
TypeScript type definitions for the JVM `jdk.internal.le` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.le
# or
pnpm add @minecraft-types/jdk.internal.le
```
