...
TypeScript type definitions for the JVM `jdk.security.jgss` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.security.jgss
# or
pnpm add @minecraft-types/jdk.security.jgss
```
