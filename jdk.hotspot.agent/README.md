...
TypeScript type definitions for the JVM `jdk.hotspot.agent` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.hotspot.agent
# or
pnpm add @minecraft-types/jdk.hotspot.agent
```
