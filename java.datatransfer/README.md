...
TypeScript type definitions for the JVM `java.datatransfer` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.datatransfer
# or
pnpm add @minecraft-types/java.datatransfer
```
