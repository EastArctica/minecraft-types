...
TypeScript type definitions for the JVM `jdk.httpserver` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.httpserver
# or
pnpm add @minecraft-types/jdk.httpserver
```
