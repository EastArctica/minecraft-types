...
TypeScript type definitions for the JVM `java.management.rmi` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.management.rmi
# or
pnpm add @minecraft-types/java.management.rmi
```
