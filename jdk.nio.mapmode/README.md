...
TypeScript type definitions for the JVM `jdk.nio.mapmode` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.nio.mapmode
# or
pnpm add @minecraft-types/jdk.nio.mapmode
```
