...
TypeScript type definitions for the JVM `java.transaction.xa` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.transaction.xa
# or
pnpm add @minecraft-types/java.transaction.xa
```
