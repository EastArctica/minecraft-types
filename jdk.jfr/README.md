# @minecraft-types/jdk.jfr

TypeScript type definitions for the JVM `jdk.jfr` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.jfr
# or
pnpm add @minecraft-types/jdk.jfr
```
