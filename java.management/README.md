...
TypeScript type definitions for the JVM `java.management` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.management
# or
pnpm add @minecraft-types/java.management
```
