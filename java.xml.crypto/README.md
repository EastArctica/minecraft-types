...
TypeScript type definitions for the JVM `java.xml.crypto` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.xml.crypto
# or
pnpm add @minecraft-types/java.xml.crypto
```
