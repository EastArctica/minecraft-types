...
TypeScript type definitions for the JVM `jdk.crypto.mscapi` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.crypto.mscapi
# or
pnpm add @minecraft-types/jdk.crypto.mscapi
```
