...
TypeScript type definitions for the JVM `jdk.internal.vm.compiler.management` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.vm.compiler.management
# or
pnpm add @minecraft-types/jdk.internal.vm.compiler.management
```
