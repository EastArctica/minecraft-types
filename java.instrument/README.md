...
TypeScript type definitions for the JVM `java.instrument` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.instrument
# or
pnpm add @minecraft-types/java.instrument
```
