...
TypeScript type definitions for the JVM `java.compiler` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.compiler
# or
pnpm add @minecraft-types/java.compiler
```
