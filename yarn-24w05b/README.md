# @minecraft-types/yarn-24w05b

Typescript definitions for Minecraft 24w05b (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-24w05b
# or
pnpm add @minecraft-types/yarn-24w05b
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-24w05b/build.<BUILD_NUMBER>"
    ]
  }
}
```
