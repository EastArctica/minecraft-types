# @minecraft-types/yarn-3D Shareware v1.34

Typescript definitions for Minecraft 3D Shareware v1.34 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-3D Shareware v1.34
# or
pnpm add @minecraft-types/yarn-3D Shareware v1.34
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-3D Shareware v1.34/build.<BUILD_NUMBER>"
    ]
  }
}
```
