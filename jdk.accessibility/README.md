...
TypeScript type definitions for the JVM `jdk.accessibility` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.accessibility
# or
pnpm add @minecraft-types/jdk.accessibility
```
