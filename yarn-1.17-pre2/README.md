# @minecraft-types/yarn-1.17-pre2

Typescript definitions for Minecraft 1.17-pre2 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.17-pre2
# or
pnpm add @minecraft-types/yarn-1.17-pre2
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.17-pre2/build.<BUILD_NUMBER>"
    ]
  }
}
```
