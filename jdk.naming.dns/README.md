...
TypeScript type definitions for the JVM `jdk.naming.dns` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.naming.dns
# or
pnpm add @minecraft-types/jdk.naming.dns
```
