...
TypeScript type definitions for the JVM `jdk.unsupported.desktop` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.unsupported.desktop
# or
pnpm add @minecraft-types/jdk.unsupported.desktop
```
