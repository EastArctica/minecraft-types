...
TypeScript type definitions for the JVM `jdk.jdwp.agent` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.jdwp.agent
# or
pnpm add @minecraft-types/jdk.jdwp.agent
```
