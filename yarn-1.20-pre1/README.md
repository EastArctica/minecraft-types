# @minecraft-types/yarn-1.20-pre1

Typescript definitions for Minecraft 1.20-pre1 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.20-pre1
# or
pnpm add @minecraft-types/yarn-1.20-pre1
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.20-pre1/build.<BUILD_NUMBER>"
    ]
  }
}
```
