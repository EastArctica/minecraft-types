...
TypeScript type definitions for the JVM `java.security.jgss` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.security.jgss
# or
pnpm add @minecraft-types/java.security.jgss
```
