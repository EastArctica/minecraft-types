...
TypeScript type definitions for the JVM `jdk.internal.opt` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.opt
# or
pnpm add @minecraft-types/jdk.internal.opt
```
