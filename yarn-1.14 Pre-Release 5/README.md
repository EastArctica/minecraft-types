# @minecraft-types/yarn-1.14 Pre-Release 5

Typescript definitions for Minecraft 1.14 Pre-Release 5 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.14 Pre-Release 5
# or
pnpm add @minecraft-types/yarn-1.14 Pre-Release 5
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.14 Pre-Release 5/build.<BUILD_NUMBER>"
    ]
  }
}
```
