...
TypeScript type definitions for the JVM `jdk.management.agent` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.management.agent
# or
pnpm add @minecraft-types/jdk.management.agent
```
