...
TypeScript type definitions for the JVM `jdk.internal.vm.ci` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.vm.ci
# or
pnpm add @minecraft-types/jdk.internal.vm.ci
```
