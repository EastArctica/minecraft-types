# @minecraft-types/yarn-1.19-pre4

Typescript definitions for Minecraft 1.19-pre4 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.19-pre4
# or
pnpm add @minecraft-types/yarn-1.19-pre4
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.19-pre4/build.<BUILD_NUMBER>"
    ]
  }
}
```
