# @minecraft-types/java.smartcardio

TypeScript type definitions for the JVM `java.smartcardio` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.smartcardio
# or
pnpm add @minecraft-types/java.smartcardio
```
