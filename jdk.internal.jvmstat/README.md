...
TypeScript type definitions for the JVM `jdk.internal.jvmstat` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.jvmstat
# or
pnpm add @minecraft-types/jdk.internal.jvmstat
```
