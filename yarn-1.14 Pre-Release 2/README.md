# @minecraft-types/yarn-1.14 Pre-Release 2

Typescript definitions for Minecraft 1.14 Pre-Release 2 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.14 Pre-Release 2
# or
pnpm add @minecraft-types/yarn-1.14 Pre-Release 2
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.14 Pre-Release 2/build.<BUILD_NUMBER>"
    ]
  }
}
```
