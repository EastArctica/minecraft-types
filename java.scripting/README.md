...
TypeScript type definitions for the JVM `java.scripting` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.scripting
# or
pnpm add @minecraft-types/java.scripting
```
