...
TypeScript type definitions for the JVM `java.security.sasl` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.security.sasl
# or
pnpm add @minecraft-types/java.security.sasl
```
