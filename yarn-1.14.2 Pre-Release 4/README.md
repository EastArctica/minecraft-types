# @minecraft-types/yarn-1.14.2 Pre-Release 4

Typescript definitions for Minecraft 1.14.2 Pre-Release 4 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.14.2 Pre-Release 4
# or
pnpm add @minecraft-types/yarn-1.14.2 Pre-Release 4
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.14.2 Pre-Release 4/build.<BUILD_NUMBER>"
    ]
  }
}
```
