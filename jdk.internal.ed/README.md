...
TypeScript type definitions for the JVM `jdk.internal.ed` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.internal.ed
# or
pnpm add @minecraft-types/jdk.internal.ed
```
