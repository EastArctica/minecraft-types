...
```bash
npm install @minecraft-types/yarn-22w13oneblockatatime
# or
pnpm add @minecraft-types/yarn-22w13oneblockatatime
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-22w13oneblockatatime/build.<BUILD_NUMBER>"
    ]
  }
}
```
