...
TypeScript type definitions for the JVM `jdk.unsupported` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.unsupported
# or
pnpm add @minecraft-types/jdk.unsupported
```
