...
TypeScript type definitions for the JVM `jdk.crypto.cryptoki` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/jdk.crypto.cryptoki
# or
pnpm add @minecraft-types/jdk.crypto.cryptoki
```
