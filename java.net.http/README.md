...
TypeScript type definitions for the JVM `java.net.http` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.net.http
# or
pnpm add @minecraft-types/java.net.http
```
