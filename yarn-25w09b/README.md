# @minecraft-types/yarn-25w09b

Typescript definitions for Minecraft 25w09b (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-25w09b
# or
pnpm add @minecraft-types/yarn-25w09b
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-25w09b/build.<BUILD_NUMBER>"
    ]
  }
}
```
