# @minecraft-types/yarn-1.14.2 Pre-Release 1

Typescript definitions for Minecraft 1.14.2 Pre-Release 1 (Fabric/Yarn mappings), all known builds.
...
```bash
npm install @minecraft-types/yarn-1.14.2 Pre-Release 1
# or
pnpm add @minecraft-types/yarn-1.14.2 Pre-Release 1
```
...
```json
{
  "compilerOptions": {
    "types": [
      "@minecraft-types/yarn-1.14.2 Pre-Release 1/build.<BUILD_NUMBER>"
    ]
  }
}
```
