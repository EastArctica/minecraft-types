...
TypeScript type definitions for the JVM `java.sql.rowset` module (JDK 21.0.8).
...
```bash
npm install @minecraft-types/java.sql.rowset
# or
pnpm add @minecraft-types/java.sql.rowset
```
